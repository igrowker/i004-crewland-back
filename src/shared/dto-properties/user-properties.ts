...
export const UsernameProperty = () =>
  applyDecorators(
    ...
    MaxLength(25, {
      message: 'El nombre de usuario no puede tener más de 25 caracteres.',
    }),
    Matches(/^[a-zA-Z0-9_-]+$/, {
      message:
...
export const DateOfBirthProperty = () =>
  applyDecorators(
    ...
    IsDateString(
      {},
      { message: 'La fecha debe ser en formato ISO (YYYY-MM-DD).' },
    ),
...
export const GenderProperty = () =>
  applyDecorators(
    ...
    IsEnum(Gender, {
      message: 'El género debe ser uno de los valores definidos.',
    }),
...
export const ArrayOfStringsProperty = () =>
  applyDecorators(IsArray(), IsOptional(), IsString({ each: true }));
